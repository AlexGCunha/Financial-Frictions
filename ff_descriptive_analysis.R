...
setwd(output_path)
ggsave("histogram_spreads.png", plot = p1)
...
setwd(output_path)
ggsave("time_series_spreads.png", plot = p2)
...
ggsave("time_series_sd_spreads.png", plot = p3)
...
ggsave("time_series_spreads_size.png", plot = p4)
...
ggsave("time_series_sd_spreads_size.png", plot = p5)
...
ggsave("time_series_spreads_enf.png", plot = p6)
...
ggsave("time_series_sd_spreads_enf.png", plot = p7)
...
ggsave("time_series_spreads_rate.png", plot = p8)
...
ggsave("time_series_sd_spreads_rate.png", plot = p9)
